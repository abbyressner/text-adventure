        ...
        if (!processed) {
            ...
            switch (weather) {
                case "wind":
                    ...
                    break;
                case "pleasant":
                    System.out.println("Shockingly, it's sunny and mild. You can walk north easily.");
                    canProceed = true;
                    break;
            }
            processed = true;
            ...
            case "go":
                if (!canProceed && weather.equals("wind")) {
                    if (player.getFlag("hasHairTie")) {
                        canProceed = true;
                        return "You tie your hair up. Now you can see! You may proceed north.";
                    } else {
                        player.setLost(true);
                ...
                if (canProceed && cmd.getTarget().equals("north")) {
